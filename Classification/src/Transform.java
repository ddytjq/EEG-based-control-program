...
public class Transform {
	...
	public static void main(String[] args) throws IOException {
		...
		eeg = new BufferedReader(new FileReader("/Users/kimyosub/Desktop/alpha.txt"));
		token = null;
		...
		eeg2 = new BufferedReader(new FileReader("/Users/kimyosub/Desktop/low_beta.txt"));
		token = null;
		...
		FileOutputStream data = new FileOutputStream("/Users/kimyosub/Desktop/smr.txt", false);
