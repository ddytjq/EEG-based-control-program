...
void setup() {
  ...
  reader_alpha = createReader("/Users/kimyosub/Documents/Processing/File_io/alpha2.txt");
  reader_beta = createReader("/Users/kimyosub/Documents/Processing/File_io/beta2.txt");
  reader_delta = createReader("/Users/kimyosub/Documents/Processing/File_io/delta2.txt");
  reader_gamma = createReader("/Users/kimyosub/Documents/Processing/File_io/gamma2.txt");
  reader_theta = createReader("/Users/kimyosub/Documents/Processing/File_io/theta2.txt");
...
void drawShape() {
  ...
  for (int i=0; i<formResolution; i++) {
    ...
    if (0.5<=float(result_delta.get(j)) && float(result_delta.get(j))<1.89999) {
      ...
      ellipse(b1[4]+centerX, b2[4]+centerY, 5, 5);
