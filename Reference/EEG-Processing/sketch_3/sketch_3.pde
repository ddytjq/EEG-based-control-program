...
void setup() {
  ...
  textSize(13);
  fill(255,255,255);
  text("Gamma", centerX-28, centerY-200);
  text("Beta", centerX+150, centerY-130);
  text("Best\nAlpha", centerX+190, centerY+10);
  text("Middle\nAlpha", centerX+80, centerY+180);
  text("Slow\nAlpha", centerX-120, centerY+180);
  text("Theta", centerX-240, centerY+30);
  text("Delta", centerX-210, centerY-130);
