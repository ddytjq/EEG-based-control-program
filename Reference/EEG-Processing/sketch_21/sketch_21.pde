...
void drawShape() {
  ...
  if (num == 1) {  
    ...
    curveVertex(d1[6]+2+centerX, d2[6]+2+centerY);
  } else if (num == 5) {
    curveVertex(d1[6]+4+centerX, d2[6]+4+centerY);
  } else if (num == 6) {
    curveVertex(d1[6]+6+centerX, d2[6]+6+centerY);
  } else if (num == 7) {
    curveVertex(d1[6]+8+centerX, d2[6]+8+centerY);
  } else if (num == 8) {
    curveVertex(d1[6]+10+centerX, d2[6]+10+centerY);
  } else if (num == 9) {
    curveVertex(d1[6]+12+centerX, d2[6]+12+centerY);
  } else if (num == 10) {
    curveVertex(d1[6]+14+centerX, d2[6]+14+centerY);
  } else if (num == 11) {
    curveVertex(d1[6]+16+centerX, d2[6]+16+centerY);
  } else if (num == 12) {
  ...
  if (0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<14.99999) {
    ...
    num = 3;
  } else if (45.0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<46.99999) {
    curveVertex((d1[0]+3)+centerX, (d2[0]+3)+centerY);
    num = 4;
  } else if (47.0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<48.99999) {
    curveVertex((d1[0]+6)+centerX, (d2[0])+6+centerY);
    num = 5;
  } else if (49.0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<50.99999) {
    curveVertex((d1[0]+9)+centerX, (d2[0]+9)+centerY);
    num = 6;
  } else if (51.0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<52.99999) {
    curveVertex((d1[0]+12)+centerX, (d2[0]+12)+centerY);
    num = 7;
  } else if (53.0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<54.99999) {
    curveVertex((d1[0]+15)+centerX, (d2[0]+15)+centerY);
    num = 8;
  } else if (55.0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<56.99999) {
    curveVertex((d1[0]+18)+centerX, (d2[0]+18)+centerY);
    num = 9;
  } else if (57.0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<58.99999) {
    curveVertex((d1[0]+21)+centerX, (d2[0]+21)+centerY);
    num = 10;
  } else if (59.0<=float(result_low_beta.get(j)) && float(result_low_beta.get(j))<59.99999) {
    curveVertex((d1[0]+24)+centerX, (d2[0]+24)+centerY);
    num = 11;
  ...
  if (num == 1 || num == 0) {  
    ...
    curveVertex((d1[0]+3)+centerX, (d2[0]+3)+centerY);
    curveVertex((d1[1]+3)+centerX, (d2[1]+3)+centerY);
  } else if (num == 5) {
    curveVertex((d1[0]+6)+centerX, (d2[0]+6)+centerY);
    curveVertex((d1[1]+6)+centerX, (d2[1]+6)+centerY);
  } else if (num == 6) {
    curveVertex((d1[0]+9)+centerX, (d2[0]+9)+centerY);
    curveVertex((d1[1]+9)+centerX, (d2[1]+9)+centerY);
  } else if (num == 7) {
    curveVertex((d1[0]+12)+centerX, (d2[0]+12)+centerY);
    curveVertex((d1[1]+12)+centerX, (d2[1]+12)+centerY);
  } else if (num == 8) {
    curveVertex((d1[0]+15)+centerX, (d2[0]+15)+centerY);
    curveVertex((d1[1]+15)+centerX, (d2[1]+15)+centerY);
  } else if (num == 9) {
    curveVertex((d1[0]+18)+centerX, (d2[0]+18)+centerY);
    curveVertex((d1[1]+18)+centerX, (d2[1]+18)+centerY);
  } else if (num == 10) {
    curveVertex((d1[0]+21)+centerX, (d2[0]+21)+centerY);
    curveVertex((d1[1]+21)+centerX, (d2[1]+21)+centerY);
  } else if (num == 11) {
    curveVertex((d1[0]+24)+centerX, (d2[0]+24)+centerY);
    curveVertex((d1[1]+24)+centerX, (d2[1]+24)+centerY);
  } else if (num == 12) {
    curveVertex(e1[0]+centerX, e2[0]+centerY);
    curveVertex(e1[1]+centerX, e2[1]+centerY);
  } else if (num == 13) {
