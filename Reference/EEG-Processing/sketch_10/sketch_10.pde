...
void setup() {
  ...
  beginShape();
  fill(25, 25, 25);
  vertex(centerX+(180*cos(radians(51.4))), centerY+(180*sin(radians(51.4))));
  vertex(centerX+(180*cos(radians(51.4))), centerY+(180*sin(radians(51.4))));
  vertex(centerX, centerY);
  vertex(centerX, centerY);
  endShape();
  ...
  beginShape();
  fill(25, 25, 25);
  vertex(centerX+(180*cos(radians(51.4*2))), centerY+(180*sin(radians(51.4*2))));
  vertex(centerX+(180*cos(radians(51.4*2))), centerY+(180*sin(radians(51.4*2))));
  vertex(centerX, centerY);
  vertex(centerX, centerY);
  endShape();
  ...
  beginShape();
  fill(25, 25, 25);
  vertex(centerX+(180*cos(radians(51.4*3))), centerY+(180*sin(radians(51.4*3))));
  vertex(centerX+(180*cos(radians(51.4*3))), centerY+(180*sin(radians(51.4*3))));
  vertex(centerX, centerY);
  vertex(centerX, centerY);
  endShape();
  ...
  beginShape();
  fill(25, 25, 25);
  vertex(centerX+(180*cos(radians(51.4*4))), centerY+(180*sin(radians(51.4*4))));
  vertex(centerX+(180*cos(radians(51.4*4))), centerY+(180*sin(radians(51.4*4))));
  vertex(centerX, centerY);
  vertex(centerX, centerY);
  endShape();
  ...
  beginShape();
  fill(25, 25, 25);
  vertex(centerX+(180*cos(radians(51.4*5))), centerY+(180*sin(radians(51.4*5))));
  vertex(centerX+(180*cos(radians(51.4*5))), centerY+(180*sin(radians(51.4*5))));
  vertex(centerX, centerY);
  vertex(centerX, centerY);
  endShape();
