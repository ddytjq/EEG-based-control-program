...
public class Sketch extends PApplet {
    ...
    ArrayList<String> result_alpha = new ArrayList<String>();
    ArrayList<String> result_beta = new ArrayList<String>();
    ArrayList<String> result_delta = new ArrayList<String>();
    ArrayList<String> result_gamma = new ArrayList<String>();
    ArrayList<String> result_theta = new ArrayList<String>();
    ...
    public void setup() {
        ...
        vertex(centerX + (centerX - 150) * cos(radians((float) a * 1)),
                centerY + (centerX - 150) * sin(radians((float) a * 1)) - (centerX / 4));  // 2
        vertex(centerX + (centerX - 150) * cos(radians((float) a * 2)),
                centerY + (centerX - 150) * sin(radians((float) a * 2)) - (centerX / 4));  // 3
        vertex(centerX + (centerX - 150) * cos(radians((float) a * 3)),
                centerY + (centerX - 150) * sin(radians((float) a * 3)) - (centerX / 4));  // 4
        vertex(centerX + (centerX - 150) * cos(radians((float) a * 4)),
                centerY + (centerX - 150) * sin(radians((float) a * 4)) - (centerX / 4));  // 5
        vertex(centerX + (centerX - 150) * cos(radians((float) a * 5)),
                centerY + (centerX - 150) * sin(radians((float) a * 5)) - (centerX / 4));  // 6
        vertex(centerX + (centerX - 150) * cos(radians((float) 51.6)),
                centerY - (centerX - 150) * sin(radians((float) 51.6)) - (centerX / 4));  // 7
        vertex(centerX + (centerX - 150), centerY - (centerX / 4));  // 1
        endShape();
        ...
        for (int i = 0; i < 6; i++) {
            ...
            vertex(centerX + (centerX - 150) * cos(radians((float) 51.4 * i)),
                    centerY + (centerX - 150) * sin(radians((float) 51.4 * i)) - (centerX / 4));
            endShape();
        }
    ...
    public void draw() {
        ...
        if (j < result_alpha.size()) {
            ...
            if (result_alpha.size() != 0 && result_beta.size() != 0 && result_delta.size() != 0
                    && result_gamma.size() != 0 && result_theta.size() != 0) {
        ...
        vertex(centerX, centerY - (centerX / 4));
        vertex(centerX + (centerX - 150) * cos(radians((float) 51.6)),
                centerY - (centerX - 150) * sin(radians((float) 51.6)) - (centerX / 4));
        endShape();
